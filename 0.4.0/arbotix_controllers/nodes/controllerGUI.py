...
""" 
  A simple Controller GUI to drive robots and pose heads.
    THIS VERSION USES THE OLDER JOINT STATES METHOD AND REQUIRES
    A JOINT CONTROLLER TO BE RUNNING
...
class controllerGUI(wx.Frame):
    ...
    def __init__(self, parent, debug = False):  
        wx.Frame.__init__(self, parent, -1, "ArbotiX Joint Controller GUI", style = wx.DEFAULT_FRAME_STYLE & ~ (wx.RESIZE_BORDER | wx.MAXIMIZE_BOX))
...
if __name__ == '__main__':
    # initialize GUI
    rospy.init_node('jc_controllerGUI')
    app = wx.PySimpleApp()
